...
@ENROLLMENT_BLUEPRINT.route('/eduhub/enrollment/<student_id>/<period_id>', methods = ['GET'])
def calculate_enrollment_hour_by_student_id(student_id,period_id):
    average=96 #enrollment.calculate_student_enrollment_average(student_id)
    start_enrrollment=7#current_enrollment_time()
